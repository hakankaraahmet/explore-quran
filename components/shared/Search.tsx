...
const Search: FC<ISearch> = ({ searchValue, setSearchValue }) => {
  ...
  return (
    <div className="w-full flex mt-8 md:mt-0 flex-col justify-center items-center bg-contain bg-no-repeat bg-center  bg-[url('/images/main_page_background.svg')] bg-secondary_color bg-opacity-[0.05]">
      <Image
